...
def _format_messages_as_prompt(
    ...
    # Tool schemas come from the shared ACP bridge (upstream's refactor, so both
    # ACP clients render specs identically). tool_choice is deliberately NOT
    # passed to it: that helper renders it as a "Tool choice hint:" line, and the
    # block below is why that wording was replaced here.
    sections.extend(_render_tool_bridge_sections(tools))
