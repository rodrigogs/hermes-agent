...
def delegate_task(
    ...
    for i, t in enumerate(task_list):
        ...
        # Upstream wrapper: snapshots/restores the parent's resolved tool
        # names around construction (under _CHILD_CONSTRUCTION_LOCK) so a
        # child's toolset cannot leak into the parent. It forwards **kwargs
        # verbatim to _build_child_agent, so the profile kwargs below keep
        # working unchanged.
