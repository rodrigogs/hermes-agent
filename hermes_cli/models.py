...
PROVIDER_GROUPS: dict[str, tuple[str, str, list[str]]] = {
    ...
    # executor could not serve. Upstream re-merged the two in the 1308-commit
    # batch absorbed on 2026-08-26, and again in the 1345-commit batch on
    # 2026-08-31; the split is kept here because the measurement above still
    # holds for this install, where the ACP executor is Claude Code and serves
    # one id.
